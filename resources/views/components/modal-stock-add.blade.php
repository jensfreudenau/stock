<div id="add-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-1/2 h-1/2 max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('transaction.add') }}" method="POST" >
                @csrf
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                        <input checked id="share" type="radio" value="share" name="shareType" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="share" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Aktie</label>
                    </div>
                    <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                        <input id="etf" type="radio" value="etf" name="shareType" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="etf" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">ETF</label>
                    </div>
                    <div class="col-span-2">
                    ...
                    <div class="col-span-2">
                        <label for="quantity" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('Anzahl')}}</label>
                    ...
                    <div class="col-span-2">
                        <label for="transaction_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('Kaufdatum')}}</label>
