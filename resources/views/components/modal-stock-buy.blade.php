        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{ route('instock.store') }}" method="POST" >
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        <label for="amount" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('gekaufte Anzahl')}}</label>
                    ...
                    <div class="col-span-2">
                        <label for="buy_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{__('Verkaufdatum')}}</label>
